...
class KeystoreApp(App):
  ...
  def compose(self) -> ComposeResult:
      ...
      with Horizontal():
          yield SidebarApp(self.ks_manager)
          ...
          with Vertical(id="content-area"):
              ...
              yield Input(placeholder="Introduce el valor...", password=True, id="input-value")
              
              yield Label("Notas:", classes="field-label")
              yield Input(placeholder="Opcional: ¿Para qué sirve esta llave?", id="input-notes")
